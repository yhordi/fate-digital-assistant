var Npc = React.createClass({
  getInitialState: function(){
    return {data: this.props.data, systemName: this.props.systemName, consequences: this.props.consequences, characterSkills: this.props.characterSkills}
  },
      ...
      <div className="row">
        ...
        <div className="row">
          ...
          <div className="col-md-6" id="consequences-container">
            <ConsequenceList npcId={this.props.data.id} consequences={this.props.data.consequences} />
          </div>
        </div>
    </div>
    );
