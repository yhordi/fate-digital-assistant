...
Location.create(name: 'California', description: 'The Golden State')
Location.create(name: 'Oakland', description: 'A lovely city in the San Francisco bay area', system_id: 1, parent_location_id: 1)
